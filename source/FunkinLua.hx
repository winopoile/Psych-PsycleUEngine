...
class FunkinLua {
	...
	public function new(script:String) {
		...
		// Character Dance
		set('Dances', 0);//Refenced from Blantados (I think this is.)
		set('CharacterDances', 0);
		set('idleToBeatIn', false);
		set('beatDelay', 0); //Luas Just Broken It.
		set('luaToChange', false);
		set('danceBeats', 0);
		set('danceLua', false);
