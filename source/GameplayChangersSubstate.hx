...
class GameplayChangersSubstate extends MusicBeatSubstate
{
	...
	function getOptions()
	{
		...
		var option:GameplayOption = new GameplayOption('Health Over Power', 'healthop', 'bool', true);
		optionsArray.push(option);

		var option:GameplayOption = new GameplayOption('Cheat Mod (Not Supposed)', 'cheatmod', 'bool', false);
		optionsArray.push(option);

		var option:GameplayOption = new GameplayOption('Sand Box Mode', 'sandbox', 'bool', false);
		optionsArray.push(option);
	}
