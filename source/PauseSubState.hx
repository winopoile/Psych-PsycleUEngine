...
class PauseSubState extends MusicBeatSubstate
{
	...
	public static var isclosed:Bool = false;
			...
			switch (swagCounter)
				{
					...
					case 1:
						...
						if (PlayState.isPixelStage)
							countdownReady.setGraphicSize(Std.int(countdownReady.width * PixelZoom));
					...
					case 2:
						...
						if (PlayState.isPixelStage)
							countdownSet.setGraphicSize(Std.int(countdownSet.width * PixelZoom));
					...
					case 3:
						...
						if (PlayState.isPixelStage)
							countdownGo.setGraphicSize(Std.int(countdownGo.width * PixelZoom));
