...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Character Dance Beats', "Value 1:Int\nValue 2: 0/1 = ON/OFF"],
		['Beats To Dance', "Value:Bools | You Can This On Beat Hit If Character Do Dance."]
	];
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var check_cameraMove = new FlxUICheckBox(320, clear_events.y + 60, null, null, "Move Camera on Note Hits", 250);
	    ...
	    check_cameraMove.callback = function()
	    {
		 ...
		 if(FlxG.save.data.check_cameraMove == null) FlxG.save.data.check_cameraMove;
	    };

		var cameratween_check = new FlxUICheckBox(320, clear_events.y - 30, null, null, 'Camera Tween', 100);
		cameratween_check.checked = _song.camTween;
		cameratween_check.callback = function()
		{
		_song.camTween = cameratween_check.checked;
		if(FlxG.save.data.cameratween_check == null) FlxG.save.data.cameratween_check;
		};
		...
		//tab_group_song.add(new FlxText(cameratween_check.x + 100, cameratween_check.y - 15, 0, 'Camera Tween:'));
		tab_group_song.add(cameratween_check);
	...
	function addSectionUI():Void
	{
		...
		stepperSectionBPM = new FlxUINumericStepper(10, check_changeBPM.y + 20, 1, Conductor.bpm, 0, 1500, 1);
